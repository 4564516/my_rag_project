...
$$x_i' = W_{\text{proj}} \cdot f_{\text{act}} (W_{\text{fc}} \cdot y_i).$$
...
traces, including the average prompt tokens (*lp*) and average generated tokens (*lg*), are listed in [Table 4.](#page-8-2)
