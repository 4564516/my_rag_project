...
Xiang  $\text{Li}^{1\dagger}$ , Yiqun Yao $^{1\dagger}$ , Xin Jiang $^{1\dagger}$ , Xuezhi Fang $^{1\dagger}$ , Xuying Meng $^2$ , Siqi Fan $^3$ , Peng Han $^3$ , Jing  $\text{Li}^4$ , Li  $\text{Du}^1$ , Bowen Qin $^1$ , Zheng Zhang $^1$ , Aixin Sun $^5$ , Yequan Wang $^{1*}$ 
...
(b) Linear growth strategy cost saving = 50 (c) Superlinear growth strategy cost saving > 50% (d) Sublinear growth strategy cost saving < 50%
