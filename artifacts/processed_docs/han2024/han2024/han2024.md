...
|             |                      |                                  | Scope-1        | <b>13</b> (11, 15)       | 0.20 (0.17, 0.24)           | 1.48 (1.26, 1.70)                 | 1%                             |  |
...
| Table 2: The m | ublic health cost | of training a large  | AI model in selected | U.S. data centers.   |
|----------------|-------------------|----------------------|----------------------|----------------------|
| 1000 2. 110 p  | none nemin coor   | of committees a mixe | 111 monet in science | CL.D. WITH CCITICID. |

<span id="page-11-1"></span>

| Location            | Electricity Price | ectricity Price   Electricity |                          | % of Electricity | Emission (Metric Ton) |               |       |  |
|---------------------|-------------------|-------------------------------|--------------------------|------------------|-----------------------|---------------|-------|--|
...
| Los Lunas, NM       | 5.75              | 1.7                           | <b>0.73</b> (0.56, 0.90) | 43%              | 0.78 (17500)          | 8.36 (7500)   | 9.84  |  |
...
| Prineville, OR      | 7.52              | 2.2                           | <b>0.23</b> (0.19, 0.28) | 10%              | 0.59 (13300)          | 4.67 (4200)   | 2.40  |  |
...
| Location              | Pearson     | :      | Normalized |              | Normalized STD |        |              |
|-----------------------|-------------|--------|------------|--------------|----------------|--------|--------------|
...
$$\min_{w} \qquad \sum_{t=1}^{T} \sum_{i=1}^{N} p_{i,t}^{e} \cdot w_{i,t} + \sum_{t=1}^{T} \sum_{i=1}^{N} p_{i,t}^{h} \cdot w_{i,t}$$
(4a)
...
<span id="page-16-2"></span><span id="page-16-0"></span>![](_page_16_Figure_2.jpeg)
...
| Location            | Energy (MWh) | Electricity Price p <sup>e</sup> (\$/MWh) | Health Price $p^h$ (\$/MWh) | Carbon Intensity $r^{C}$ (ton/MWh) |
|---------------------|--------------|-------------------------------------------|-----------------------------|------------------------------------|
